            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h2>Form Edit Posisi</h2>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">

                        <?php if (session('gagal-update-posisi')) :  ?>
                            <div class="alert alert-danger" role="alert">
                                <?= session('gagal-update-posisi');  //  Delete success 
                                ?>
                            </div>
                        <?php endif; ?>

                     
                        <form action="<?= route_to('/posisi/edit/', $posisi['id']) ?>" 
                        method="post">
                            <?= csrf_field() ?>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    name="posisi" id="posisi" value="<?= $posisi['posisi'] ?>">     
                                </div>
                            </div>
