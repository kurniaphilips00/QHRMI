            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php if (session('gagal-menambah-kategori')) :  ?>
                            <div class="alert alert-danger" role="alert">
                                <?= session('gagal-menambah-kategori');  //  Delete success 
                                ?>
                            </div>
                        <?php endif; ?>

                        <?php if (session('sukses-tambah-kategori')) :  ?>
                            <div class="alert alert-info" role="alert">
                                <?= session('sukses-tambah-kategori');  //  Delete success 
                                ?>
                            </div>
                        <?php endif; ?>
                        ...
                        <form action="<?= base_url('/kategori/tambah') ?>" method="post">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control <?= $validation->hasError('kategori') ? 'is-invalid' : null ?>" 
