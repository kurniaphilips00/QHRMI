            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('/sertifikat/tambah') ?>" method="post">
                            <?= csrf_field() ?>
                            <div class="mb-3 row">
                            ...
                            <div class="mb-3 row">
                                <label for="sertifikat" class="col-sm-2 col-form-label">Nomor Sertifikat</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control <?= $validation->hasError('sertifikat') ? 'is-invalid' : null ?>" 
                                    name="sertifikat" id="sertifikat" placeholder="Sertifikat">
                                    <?php if ($validation->hasError('sertifikat')) : ?>
                                        <div class="invalid-feedback" style="color:red">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" class="form-control" name="tgl_kadaluarsa" 
                                    id="txtKadaluarsa" placeholder="Tgl. Kadaluarsa">
                                </div>
                                <div class="col-sm-2">
