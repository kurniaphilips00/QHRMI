                ...
                <div class="card">
                    <div class="card-header mx-2">
                        <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                            ...
                            <form action="<?= base_url("/imt") ?>" method="get" enctype="multipart/form-data" style="display: inline;">
                                <div class="btn-group" role="group">
                                    <!--<label for="files" class="btn">Pilih file excel</label>-->
                                    <input style="width:280px;height: 30px;" type="text" name="keyword" 
                                    placeholder="Masukkan kata yang dicari..."></input>
                                </div>
                                
                                <button title="" type="submit" class="btn" name="submit"
                                style="width:80px;height: 30px; background-color:#90e1f5; color:black">Cari</button>
                            </form>
                    ...
                    <div class="card-body">
                        ...
                        <?php endif; ?>
                        <form action="<?= base_url("/imt/intermitten_detil") ?>" method="GET" target="_blank">
