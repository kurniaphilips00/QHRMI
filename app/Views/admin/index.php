      ...
      <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h2 class="mt-4 mx-3">Daftar Tenaga Ahli PT. Quantum HRMI</h2>
                        ...
                        <div class="d-flex justify-content-start">
                                ...
                                <div class="btn-group mx-1 px-1">
                                    <button type="button" style = "width:100px; background-color:#90e1f5; border: none;" 
                                        class="btn btn-light dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"
                                    title="Filter Usia" ><i class="fa-solid fa-filter"></i>
                                        Usia
                                    </button>
                                ...
                                <div class="btn-group mx-1 px-1">
                                    <button type="button" style = "width:80px; background-color:#90e1f5; border: none;"  
                                    class="btn btn-light dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"
                                    title="Filter S1" ><i class="fa-solid fa-filter"></i>
                                        S1
                                    </button>
                                ...
                                <div class="btn-group mx-1 px-1">
                                    <button type="button" style = "width:80px; background-color:#90e1f5; border: none;" 
                                    class="btn btn-light dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"
                                    title="Filter S2" ><i class="fa-solid fa-filter"></i>
                                        S2
                                    </button>
                                ...
                                <div class="btn-group mx-1 px-1">
                                    <button type="button" style = "width:80px; background-color:#90e1f5; border: none;" 
                                    class="btn btn-light dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"
                                    title="Filter S3" ><i class="fa-solid fa-filter"></i>
                                        S3
                                    </button>
                                ...
                                <div class="col-sm-5 mx-3 px-3">
                                    <select class="form-select" style = "width:300px; background-color:#90e1f5;" 
                                    title="Posisi" name="posi" id="positions" onclick="position()">
                                ...
                                <div class="col-sm-2 mx-2 px-2">
                                    <a href="" class=btn btn-primary style = "width:40px; background-color:#90e1f5; " 
                                    data-bs-toggle="modal" data-bs-target="#importExcel" title="Import from Excel">
                        ...
                        <div class="d-flex justify-content-end mx-5">
                            <form class="row g-3" action="/urutSIPP_ED" method="post">  
                                <button class="btn btn-primary" style = "width:130px; background-color:#fc0b03" 
                                data-bs-toggle="modal" data-bs-target="importExcel" title="Urut Tanggal Kadaluarsa SIPP">
                                <i class="fa-sharp fa-solid fa-sort"></i></i>Kadaluarsa</button> 
                            </form>
                        </div>

                         <!--/////////////import:Data berhasil di-impor//////////////////-->
                        <?php if (session('import')) :  ?>
                            ...
                            <div class="card-body">                                
                                <table id="datatablesSimple">
                                    ...
                                    <thead>
                                        ...
                                        <th scope="col" style = "width:10%; text-align:center">No. SIPP</th>
                                        <th scope="col" style = "width:10%; text-align:center">Tgl. kadaluarsa SIPP</th> 
                                        <th scope="col" style = "width:10%; text-align:center">Expired days(SIPP)</th>  
                                        <th scope="col" style = "width:10%; text-align:center">Expired days(STR)</th> 
                                        <th scope="col" style = "width:10%; text-align:center">Usia</th> 
                                                ...
                                                <?php
                                                        ...
                                                        if ($tglED_SIPP!='0000-00-00') {
                                                            if ($tglED_SIPP=='' || $tglED_SIPP==null) {
                                                                $keterangan_SIPP = "belum terdaftar";
                                                            }
                                                            else {
                                                        ...
                                                        if ($tglED_STR!='0000-00-00') {
                                                            if ($tglED_STR=='' || $tglED_STR==null) {
                                                                $keterangan_STR = "belum terdaftar";
                                                            }
                                                            else {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php endif; ?>
                                                         ...
                                                         <td style = "width:10%"><?= $tglED_STR; ?></td>-------------------------------->
