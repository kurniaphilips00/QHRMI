...
class TA extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('ta/idx', $data);
    }

     //? Menampilkan  daftar tenaga ahli dengan Datatables Server Side
     public function indexAjax() {
        ...
        $data = $this->rhModel->tampilkan($katakunci, $start, $length);
        $jmlData = $this->rhModel->tampilkan($katakunci);
