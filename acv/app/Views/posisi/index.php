            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Posisi Tenaga Ahli</h1>
                
                        <div class="card mb-4">
                          <!--  <div class="card-header">
                                <i class="fas fa-table me-1"></i>                                                             
                                <a href="/tambah-posisi" class="btn btn-success p-2"><i class="fas fa-plus-circle"></i>Tambah Data Posisi</a>
                            </div>-->
                                ...
                                <table id="datatablesSimple">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th scope="col" style = "width:50%; text-align:center">Posisi</th>                                                                                                                              
                                            <th scope="col" style = "width:20%; text-align:center">Edit</th>                                
                                        </tr>
                                    </thead>
                                    <tbody>
                                            <?php $i = 1; ?>
                                            <?php foreach ( $posisi as $v) : ?>
                                                <tr>
                                                    <td style = "widht:5%; text-align:center"><?= $i; ?></td>
                                                    <td style = "width:50%"><?= $v->posisi; ?></td>                                                                                                                                                                                                
                                                    <td style = "width:20%; text-align:center">     
                                                        ...
                                                        <a href="/delete-posisi/<?= $v->id;?>" onclick="return confirm('Yakin ingin menghapus')">
    ...
    <div class="modal fade" id="tambah" data-bs-backdrop="static">
            <div class="modal-dialog modal-xl">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Tambah Posisi Tenaga Ahli</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                        <!--base_url bisa juga memakai route_to('tambah-posisi')  -->                                        
                        <form action="<?= base_url('tambah-posisi') ?>" method="post">
                        <?=csrf_field() ?>
    ...
    <?php foreach ( $posisi as $v) : ?>
        <div class="modal fade" id="baca<?= $v->id; ?>" data-bs-backdrop="static">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Baca Posisi Tenaga Ahli</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                        <!--base_url bisa juga memakai route_to('tambah-posisi')  -->                                        
                        <form action="<?= base_url('baca-posisi') ?>" method="post">
                        <?=csrf_field() ?>
                            ...
                            <div class="row g-3">
                                <div class = "mb-3 row">
                                        ...
                                        <div class="m-12 row">
                                            <label for="posisi" style="width:200">Posisi</label>
                                                <input type="text" class="form-control" readonly name="posisi" id="posisi" 
                                                value="<?= $v->posisi; ?>">         
                                       </div>
...
<?php foreach ( $posisi as $v) : ?>
        <div class="modal fade" id="update<?= $v->id; ?>" data-bs-backdrop="static">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="staticBackdropLabel">Update Posisi Tenaga Ahli</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <!--base_url bisa juga memakai route_to('tambah-posisi')  -->                                        
                        <form action="<?= base_url('update-posisi'.$v->id) ?>" method="post">
                            <?=csrf_field() ?>
                            <div class = "mb-3 row">
                                <div class="input-group mb-1">
                                    <span class="input-group-text" id="nama">Posisi</span>
                                    <input type="text" class="form-control" name="posisi" id="posisi" value="<?= $v->posisi; ?>" required>
                                </div>
<!--
                                <div class="mb-3">
                                    <label for="posisi">Posisi</label>
                                    <input type="text" name="posisi" id="posisi" class="form-control" value="<?= $v->posisi; ?>" required>       
                                </div>  -->
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
                                    <button type="submit" class="btn btn-primary">Simpan</button>
