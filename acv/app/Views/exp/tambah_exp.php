            ...
            <div class="col-12"><br><br>
                ...
                <form action="<?= route_to('simexp') ?>" method="post">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control <?= $validation->hasError('tahun') ? 'is-invalid' : null ?>" name="tahun" value="<?= old('tahun') ?>" placeholder="Tahun Kegiatan">
                    ...
                    <div class="mb-1 row">
                        <label for="id" class="col-sm-2 col-form-label">ID Personil</label>
                        <div class="col-sm-10">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" readonly name="nama_ta" id="Nama_Personil" placeholder="Nama Personil">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control <?= $validation->hasError('kegiatan') ? 'is-invalid' : null ?>" name="kegiatan" id="aktifitas" value="<?= old('kegiatan') ?>" placeholder="Nama Kegiatan">
                    ...
                    <div class="mb-3 row">
                        <label for="editor" class="col-sm-2 col-form-label">Uraian Tugas</label>
                        <div class="col-sm-10">
