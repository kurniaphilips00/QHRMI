            ...
            <div class="col-12"><br><br>
                ...
                <form action="<?= route_to('edit-pengalaman') ?>" method="post">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10"><input type="text" class="form-control" name="nama_ta" id="nama_ta" value="<?= $exp['nama_ta'] ?>" readonly>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        <label for="nama" class="col-sm-2 col-form-label">ID</label>
                        <div class="col-sm-10"><input type="text" class="form-control" name="kode_ta" id="kode_ta" value="<?= $exp['kode_ta'] ?>" readonly>
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control <?= $validation->hasError('tahun') ? 'is-invalid' : null ?>" name="tahun" id="tahun" value="<?= old('tahun', $exp['tahun']) ?>" placeholder="Tahun Kegiatan">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control <?= $validation->hasError('kegiatan') ? 'is-invalid' : null ?>" name="kegiatan" value="<?= old('kegiatan', $exp['kegiatan']) ?>" placeholder="Nama Kegiatan">
                    ...
                    <div class="mb-3 row">
                        <label for="pengguna" class="col-sm-2 col-form-label">Pengguna Jasa</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control <?= $validation->hasError('pengguna') ? 'is-invalid' : null ?>" name="pengguna" id="pengguna" value="<?= old('pengguna', $exp['pengguna']) ?>" placeholder="Nama pengguna">
                    ...
                    <div class="mb-3 row">
                        <label for="pers" class="col-sm-2 col-form-label">Nama Perusahaan</label>
                        <div class="col-sm-10">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <textarea name="editor1" value="<?= old('uraian', $exp['uraian']) ?>" id="uraian" cols="100" rows="10">
                                <?= $exp['uraian'] ?>
                            </textarea>
                        </div>
                    </div>
                    ...
                    <div class="mb-1 row">
                        <label class="col-sm-2 col-form-label">Awal Pelaksanaan</label>
                        <div class="col-sm-2">
                            <input type="text" class="form-control" name="mulai" id="awal00" value="<?= old('mulai', $tgl_mulai) ?>">
                        </div>
                        <div class="col-sm-2"><input type="date" class="form-control" id="awal01" onchange="start()"></div>
                    </div>
                    <div class="mb-3 row px-0">
                        <label class="col-sm-2 col-form-label mx-0">Akhir Pelaksanaan</label>
                        <div class="col-sm-2">
                            <input type="text" class="form-control" name="selesai" id="akhir00" value="<?= old('selesai', $tgl_selesai) ?>">
                        </div>
                        <div class="col-sm-2"><input type="date" class="form-control" id="akhir01" onchange="end()"></div>
                    </div>

                    <div class="mb-3 row">
                        <label class="col-sm-2 col-form-label">Intermitten</label>
                        <div class="col-sm-5 mx-0">
                            <input type="text" class="form-control mx-0" name="inter" id="Intermitten" style="width:500" value="<?= old('inter', $exp['inter']) ?>">
                        </div>

                        <label class="col-sm-2 col-form-label mx-0">Jml bulan</label>
                        <div class="col-sm-2 mx-0"><input type="text" class="form-control mx-0" name="jml_bln" id="Bulan" style="width:100" value="<?= old('jml_bln', $exp['jml_bln']) ?>">
                        </div>
                    </div>
                    ...
                    <div class="mb-3 row">
                        <label for="referensi" class="col-sm-2 col-form-label">Surat Referensi</label>
                        <div class="col-sm-8">
