                            ...
                            <?php foreach ($exp as $v) : ?>
                                <tr>
                                    ...
                                    <td style="width:15%; text-align:center;  font-size: 5px;">
                                        ...
                                        <button type="button" data-bs-toggle="modal" data-bs-target="#baca<?= $v['id_exp']; ?>" class="btn btn-sm btn-warning" id="#baca" title="baca">
                                            ...
                                            <a href="/edit-pengalaman/<?= $v['id_exp']; ?>">
                                                <i class="fa-solid fa-pencil"></i></button>|<button type="button" class="btn btn-sm btn-warning" title="hapus">
                    ...
                    <div class="modal-body">
                        <form action="<?= base_url('#') ?>" method="post">
                            ...
                            <div class="mb-1 row">
                                ...
                                <div class="col-sm-8">
                                    <textarea name="uraian" readonly cols="100" rows="6" ALIGN=LEFT style="width: 700px;
                                    height: 100px; 
                                    text-align: left;
                                    padding-left:0;
                                    padding-top:0;
                            ...
                            <div class="mb-1 row">
                                <label class="col-sm-3 col-form-label">Intermitten</label>
                                <div class="col-sm-6">
